...
const productoController = {
    ...
    getAllProductos: async (req, res) => {
        try {
                ...
                include: [
                    {
                        ...
                        // 🚀 FILTRAR POR CATEGORÍA NO DESACTIVADA EN LA TIENDA
            ...
            if (!isTodos) {
                ...
                // Asegurar que solo vemos productos activos en la tienda (incluso si no tienen stock)
            ...
            const mappedProducts = rows.map(p => {
                ...
                // 🚀 VISTA LITE PARA LA TIENDA (incluye lo necesario para el Modal)
                if (!isTodos) {
                    return {
                        id: pPlain.id,
                        nombre: pPlain.nombre,
                        categoria: pPlain.categoria || pPlain.categoriaData?.nombre || 'General',
                ...
                // VISTA FULL PARA EL ADMIN (Compatibilidad Total con Compras y Inventario)
                return {
                    ...pPlain,
                    id_producto: pPlain.id,
                    talla: pPlain.talla || (pPlain.tallasStock?.[0]?.talla || ''), // Para el selector de Compras
                    precio: pPlain.precioVenta,
    ...
    /**
     * Obtener productos por nombre de categoría (Limpio)
     */
    ...
    /**
     * Obtener un producto por ID (FULL DETAIL LIMPIO)
     */
    getProductoById: async (req, res) => {
        try {
            ...
            // 🚀 FILTRO INTELIGENTE: 
            // - Para la Tienda: Ocultar campos vacíos/cero para ahorrar espacio.
            // - Para el Admin: Mostrar TODO para poder editar (incluso lo que está en 0).
            ...
            // Forzamos campos críticos para la tienda
