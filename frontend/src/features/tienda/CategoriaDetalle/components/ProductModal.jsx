...
const ProductModal = ({
  ...
  const getWholesalePrice = (qty, prod) => {
    ...
    const mayorista80 = parseFloat(prod.precioMayorista80) || 0;
    const mayorista6 = parseFloat(prod.precioMayorista6) || 0;
    const precioOferta = parseFloat(prod.precioOferta) || 0;
    const precioNormal = parseFloat(prod.precio) || 0;

    if (q >= 80 && mayorista80 > 0) return mayorista80;
    if (q >= 6 && mayorista6 > 0) return mayorista6;
    return isOffer ? precioOferta : precioNormal;
  };
            ...
            <div className="gm-price-row">
              ...
              <div className="gm-modal-tags-inline">
                ...
                parseFloat(product.precioMayorista80) > 0 ? (
                  <span
                    className="gm-tag gm-tag--destacado"
                  ...
                  <span
                    className="gm-tag gm-tag--featured"
                    style={{ backgroundColor: "#2a4a6f", color: "#fff" }}
                  >
                    Mayorista 6+
                  </span>
                ) : null}
